class BusinessNews {
    ...
    final List<BusinessArticle> articles;
    ...
    factory BusinessNews.fromJson(Map<String, dynamic> json) => BusinessNews(
        ...
        articles: json["articles"] == null ? null : List<BusinessArticle>.from(json["articles"].map((x) => BusinessArticle.fromJson(x))),
    );
...
class BusinessArticle {
    ...
    factory BusinessArticle.fromJson(Map<String, dynamic> json) => BusinessArticle(
